...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97] hover:scale-[1.02]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_4px_20px_0_hsl(261_100%_60%_/_0.4)] hover:shadow-[0_0_30px_hsl(261_100%_60%_/_0.5)]",
        destructive:
        ...
        luxury: "bg-gradient-to-r from-primary to-primary-light text-primary-foreground font-semibold shadow-[0_4px_20px_0_hsl(261_100%_60%_/_0.4)] hover:shadow-[0_0_40px_hsl(261_100%_60%_/_0.6)]",
        success: "bg-emerald-600 text-white hover:bg-emerald-700 shadow-[0_4px_20px_0_hsl(142_76%_36%_/_0.4)]",
      },
      size: {
