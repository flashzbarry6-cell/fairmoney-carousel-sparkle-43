...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "relative rounded-2xl border border-primary/15 bg-card/95 text-card-foreground backdrop-blur-xl overflow-hidden",
      "shadow-[0_12px_50px_-12px_hsl(261_100%_60%_/_0.15)]",
