...
const Index = () => {
  return (
    <>
      {/* ✅ Helmet controls how your link looks when shared */}
      <Helmet>
        <title>Lumexzz Win — Earn Smart 💰</title>
        <meta
          name="description"
          content="Your winning edge in financial freedom. Earn Smart with Lumexzz — Withdraw Instantly | Join Now!"
        />
        <meta property="og:title" content="Lumexzz Win — Earn Smart 💰" />
        <meta
