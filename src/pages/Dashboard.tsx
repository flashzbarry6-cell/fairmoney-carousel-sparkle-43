...
<div className="bg-gradient-to-br from-black via-purple-950 to-purple-700 rounded-2xl p-6 mb-6 mx-2 border border-purple-500/30">
  <div className="text-center mb-4">
    <h2 className="text-2xl font-bold text-gold mb-2">GO Lumexzz?</h2>
    <div className="w-16 h-1 bg-gradient-to-r from-purple-500 to-black mx-auto mb-4" />
  </div>
  ...
  <div className="space-y-3 mb-6">
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        <p className="text-white text-sm">
          Bank-level encryption protects your transactions and personal data
        </p>
      </div>
    </div>
    ...
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        <p className="text-white text-sm">
          Fast withdrawals and secure transactions in seconds
        </p>
      </div>
    </div>
    ...
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        <p className="text-white text-sm">
          24/7 trusted and guaranteed service uptime
        </p>
      </div>
    </div>
  </div>
