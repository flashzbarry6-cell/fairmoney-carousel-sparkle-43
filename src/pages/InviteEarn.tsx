...
const PlayGames = () => {
  ...
  // ✅ Redirect users to withdraw amount page immediately
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-950 to-black p-4 max-w-md mx-auto pb-24">
      ...
      <div className="flex flex-col items-center justify-center min-h-[70vh]">
        ...
        <div className="text-center space-y-4 px-4">
          ...
          <p
            className="text-purple-200 text-lg animate-fade-in"
            style={{ animationDelay: "0.2s" }}
          >
            Exciting games are on their way!
          </p>
          <p
            className="text-gray-400 text-sm max-w-sm mx-auto animate-fade-in"
            style={{ animationDelay: "0.4s" }}
          >
            Get ready to play, compete, and earn rewards. We're working hard to
            bring you the best gaming experience.
          </p>
        </div>
